...
export const skill = {
    ...
    emoji: "📊",
    requires: { os: ["windows"] },
    description: "📊 BİLGİSAYAR DOKTORU — RAM kaç GB dolu, Harddisk dolmuş mu, Cihaz yavaşlamış mı gibi teknik durumları size söyler. Sadece Windows bilgisayarlarda çalışır.",
    parameters: {
        type: "object",
        properties: {
            metric: {
                ...
                description: "İzlenecek sistem kaynağı (örn: 'cpu', 'ram', 'disk', 'all')"
            }
        },
        required: ["metric"]
    },
