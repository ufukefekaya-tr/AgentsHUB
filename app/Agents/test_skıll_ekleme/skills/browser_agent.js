/*
name: "browser_agent"
description: "Arka planda (headless) sanal bir tarayıcı açarak sayfaları dolaşır, JavaScript içeren dinamik sayfaları okur."
category: "search"
emoji: "🌐"
...
export const schema = {
    type: "object",
    properties: {
        url: { type: "string", description: "Ziyaret edilecek tam web adresi (http/https)" },
        extract_text: { type: "boolean", description: "Sayfanın görünür metnini ayıkla ve geri döndür" },
        wait_for_selector: { type: "string", description: "İsteğe bağlı. Veri çekmeden önce bu CSS class'ın/id'nin belirmesini bekle (örn: '.main-content')" },
        run_script: { type: "string", description: "İsteğe bağlı. Sayfada çalıştırılacak ekstra JS blok kodu (Gelişmiş tıklama vb.)" }
    },
    required: ["url"]
};
