...
export const skill = {
    ...
    emoji: "📸",
    requires: { os: ["windows"] },
    description: "📸 EKRAN FOTOĞRAFÇISI — Sadece mesaj yazmak yerine ajana \"Ekranın resmini çeksene hatayı gör\" diye komut verdiğinizde ekranınızın fotoğrafını okur inceler. Sadece Windows İşletim Sisteminde Çalışır.",
    parameters: {
        type: "object",
        properties: {
            action: {
            ...
            filename: {
                type: "string",
                description: "Kaydedilecek özel dosya adı"
            },
            filepath: {
                type: "string",
                description: "Okunacak veya bilgi alınacak dosyanın yolu"
            }
        },
        required: ["action"]
    },
