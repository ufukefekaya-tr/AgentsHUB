/*
name: "python_runner"
description: "🐍 PYTHON ÇALIŞTIRICI — Ajanın veri analizi veya özel işler için Python kodları yazıp oynatmasını sağlar. ⚠️ Bilgisayarınızda Python programı yüklü değilse BU EKLENTİ ÇALIŞMAZ."
category: "system"
emoji: "🐍"
...
export const schema = {
    type: "object",
    properties: {
        src_code: { type: "string", description: "Sistemde çalıştırılacak Python kaynak kodu" },
        custom_filename: { type: "string", description: "Kaydedilecek özel dosya adı" }
    },
    required: ["src_code"]
};
