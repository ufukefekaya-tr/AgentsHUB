...
description: "🦆 ÜCRETSİZ İNTERNET ARAMA (DuckDuckGo) — Hiç bir üyelik işlemi yapmadan BEDAVAYA internette güncel bilgi araması yapar. Kurması en kolay arama eklentisidir."
category: "search"
emoji: "🦆"
...
export const schema = {
    type: "object",
    properties: {
        query: { type: "string", description: "Arama motorunda aranacak kelime veya cümle (örn: 'Türkiye güncel haberler')" }
    },
    required: ["query"]
};
