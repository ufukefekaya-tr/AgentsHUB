...
export const skill = {
    ...
    description: "🌤️ HAVA TAHMİNİ — Günlük 3 veya 5 günlük hava durumu tahminini şehir söylemenizle birlikte söyler. Hiç bir üyelik ya da ücret istemez. Ücretsiz temel özelliktir.",
    parameters: {
        type: "object",
        properties: {
            city: {
                type: "string",
                description: "Hava durumu gibi sorgular için hedef şehir adı (örn: 'Istanbul')"
            }
        },
        required: ["city"]
    },
