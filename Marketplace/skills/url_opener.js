...
export const skill = {
    ...
    emoji: "🔗",
    requires: { os: ["windows"] },
    description: "🔗 İNTERNET SAYFASI AÇICI — Bilgisayarda Google, Youtube, Wikipedia vs ajanın kendi kendine tıklayıp ekranınızda açmasını sağlar. Siz ekranda izlersiniz. Ama ajan içeriği OKUYAMAZ.",
    parameters: {
        type: "object",
        properties: {
            url: {
