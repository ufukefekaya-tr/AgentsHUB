...
export const skill = {
    ...
    description: "📦 YETENEK YÜKLEYİCİ — 28 yeteneğin bulunduğu mağazada ajanın yetenek yüklemesini veya kaldırmasını sağlar. Normal bir çalışmada BU YETENEK KESİNLİKLE KURULU OLMALIDIR.",
    parameters: {
        type: "object",
        properties: {
            action: {
            ...
            skill_name: {
                type: "string",
                description: "Oluşturulacak eklenti/yeteneğin kısa adı"
            }
        },
        required: ["action"]
    },
