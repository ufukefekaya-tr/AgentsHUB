/*
name: "health_checker"
description: "🛡️ SİTE/SERVİS İZLEYİCİ — Web sitenizin çökerse size haber vermesini sağlayan bir kontroldür. \"Benim uygulama çalışıyor mu\" gibi sorular için sunucu yöneticileri tarafından kullanılır."
category: "system"
emoji: "🛡️"
...
export const schema = {
    type: "object",
    properties: {
        urls: { type: "array", items: { type: "string" }, description: "Kontrol edilecek veya izlenecek web adresleri listesi" },
        check_timeout_ms: { type: "number", description: "Zaman aşımı süresi (milisaniye cinsinden)" }
    },
    required: ["urls"]
};
