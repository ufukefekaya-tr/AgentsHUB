/*
name: "pdf_extractor"
description: "📄 PDF OKUYUCU (GELİŞMİŞ) — Bilgisayardaki PDF dosyalarından hatasız okuma yapar. Uzun sayfaları bile anlar. ⚠️ Çalışması için ek eklentilerine ihtiyacı vardır (Teknik Bilgi İster)."
category: "file"
emoji: "📄"
...
export const schema = {
    type: "object",
    properties: {
        file_path: { type: "string", description: "Okunacak PDF dosyasının tam yerel dosya yolu (örn: ./Workspace/rapor.pdf veya /home/user/docs/rapor.pdf)." },
        max_pages: { type: "number", description: "Okunacak maksimum sayfa sayısı. (Varsayılan 10)." },
